**THIS REPO IS NO LONGER BEING MAINTAINED! EMBER DOCS ARE NOW GENERATED BY A [RAKE TASK](https://github.com/emberjs/ember.js#building-api-docs) & [YUIDoc](http://yui.github.io/yuidoc/).**
